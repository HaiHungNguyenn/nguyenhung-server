...
namespace NguyenHung.DAL.Migrations
{
    ...
    [Migration("20240713144549_InitDb")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NguyenHung.DAL.Models.RecipeCookingWear", b =>
                {
                    ...
                    b.Property<Guid>("CookingWearId1")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("NguyenHung.DAL.Models.Nutrient", b =>
                {
                    b.HasOne("NguyenHung.DAL.Models.Product", null)
                        .WithMany("Nutrients")
                        .HasForeignKey("ProductId")
                        .IsRequired();
            ...
            modelBuilder.Entity("NguyenHung.DAL.Models.Product", b =>
                {
                    b.HasOne("NguyenHung.DAL.Models.Category", null)
                        .WithMany("Products")
            ...
            modelBuilder.Entity("NguyenHung.DAL.Models.RecipeCookingWear", b =>
                {
                    b.HasOne("NguyenHung.DAL.Models.CookingWear", null)
                    ...
                    b.HasOne("NguyenHung.DAL.Models.CookingWear", "CookingWear")
                        .WithMany()
                        .HasForeignKey("CookingWearId1")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("NguyenHung.DAL.Models.Recipe", null)
                        .WithMany("RecipeCookingWears")
